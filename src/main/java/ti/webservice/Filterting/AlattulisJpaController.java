...
import ti.webservice.Filterting.exceptions.NonexistentEntityException;
import ti.webservice.Filterting.exceptions.PreexistingEntityException;
...
public class AlattulisJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.webservice_Filterting_jar_0.0.1-SNAPSHOTPU");
